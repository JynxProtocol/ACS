...
string  stance      = ")<SF>(  Dagger Ready Stance";
...
hit(string type, string anim, string sound)
{
    ...
    if (strike == "Dagger 2" || strike == "Dagger 1")  
    {
...
default
{
    ...
    {  
        ...
        if(llGetSubString(msg,0,8)=="leftduals")
            {
                
                if(llGetSubString(msg,10,-1)==(string)owner)
                {
                    leftAttached=(integer)llGetSubString(msg,9,9);
                }
            }
