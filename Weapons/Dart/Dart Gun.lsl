...
string AttackPrim = "atcoaesd02";
string FireRequest = "atcogasp06";

float velocity    = 60.0;
vector vecAimOffsetConstant = <0.0, 0.0, 0>;
vector vecAimOffset;
string stance      = "hold_r_handgun";
...
fire()
{
    ...
    if (fireanim != "") {
        ...
        llStartAnimation("dart_gun_attack-Kamala");
    }   
        ...
        if (Stamina < 0)
    {
         ...
         llSay(acsChannel,(encrypt(AttackPrim)));
    ...
    Stamina = Stamina -1;
    llRezObject("dart", pos, fwd, rot, 2);
